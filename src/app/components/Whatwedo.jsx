...
const Whatwedo = () => {
  return (
    <div>
      <section>
        <Container>
          <div className="p-8 md:p-12 lg:p-16 bg-gray-800 backdrop-blur-md shadow-md rounded-xl ">
