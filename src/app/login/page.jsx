...
const Login = () => {
  return (
    <div>
      <section className="bg-[url('/loginimage.png')] bg-cover bg-center ">
        <Container>          
            <div className="relative min-h-screen">
              <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-gray-900  w-[500px] p-4 [box-shadow:0_2px_10px_-3px_rgba(6,81,237,0.3)] rounded-md">
                <div className="w-full px-4 py-4">
                  <form>
                    ...
                    <div>
                      <label className="text-primary text-[13px] font-medium block mb-2">
                        Email
                      </label>
                      <div className="relative flex items-center">
                        <input
                          ...
                          type="text"
                          required=""
                          className="w-full text-white text-sm border-b border-slate-300 focus:border-blue-600 pl-2 pr-8 py-3 outline-none"
